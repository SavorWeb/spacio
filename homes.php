	...
	<section class="row">
		<div class="colspan12-7 as-grid typeset top-articles">
			<div id="feature1" class="editable">
				<h1>Philosophy</h1>
				<p>SPACIO indeed accomplishes stunning design/build projects. We undertake select Custom Home projects, and also maintain a wealth of experience in the condominium and high-end commercial building arenas. We are committed to perfection, yet the most significant aspect of our approach is rooted in open dialogue. We listen. We’re proactive. We deliver on what we promise. And you always know where we stand. SPACiO knows how important the end result is to you – and we place just as much significance on the process getting there. We’re here to make it easy for you.</p>
			</div>
			<div class="btn-wrap">
			...
			<div id="feature2" class="editable">
				<h1>Expertise</h1>
				<p>SPACiO is a full service general contractor with expertise in custom homes, condominiums, and large-scale commercial projects - having worked with such elite brands as Marriott, Nobu, Breitling, and Eden Roc Hotel. Our comprehensive design/build solutions transcend the typical experience, as we deliver the rare marriage of unequaled quality and unmatched customer service.</p>
			</div>
			<div class="btn-wrap">
