...
<style>
	.main-cover {
		background-image: url(media/photos/commercial_hero.jpg);
	}
	...
	<section class="row" id="about-us">
		<div class="colspan12-7 as-grid typeset top-articles">
			<div id="feature1" class="editable">
				<h1>Philosophy</h1>
				<p>SPACIO indeed accomplishes stunning design/build projects. We have a wealth of experience in the high-end commercial building arena, and we are committed to perfection. Yet, the most significant aspect of our approach is rooted in open dialogue. We listen. We’re proactive. We deliver on what we promise. And you always know where we stand. SPACiO knows how important the end result is to you – and we place just as much significance on the process getting there. We’re here to make it easy for you.</p>
			</div>
			<div class="btn-wrap">
			...
			<div id="feature2" class="editable">
				<h1>Expertise</h1>
				<p>SPACiO is a full service general contractor with expertise in large-scale commercial projects, having worked with such elite brands as Marriott, Nobu, Breitling, and Eden Roc Hoel. We also possess extensive build-out and renovation proficiency in the condominium and custom home market. Our comprehensive design/build solutions transcend the typical experience, as we deliver the rare marriage of unequaled quality and unmatched customer service.</p>
			</div>
			<div class="btn-wrap">
...
<section class="row typset">
	...
	<div class="colspan12-6 colspan6-3 as-grid with-gutter review" id="review2">
		<blockquote class="editable">
			<p class="quote">As you can imagine, we are highly protective of our Nobu brand, and we’re very diligent about selecting the right partners for any project we undertake. After selecting SPACiO to lead the construction of our new restaurant in South Beach, we realized we made the perfect choice. Highly skilled and extremely responsive, the SPACiO team seamlessly delivered.</p>
			<p class="source"><b>NOBU</b> <br>Exec</p>
		</blockquote>
	</div>
</section>
</div>
...
<!-- //////   BEGIN MODALS    ////// -->
		...
		<div id="leader-roles" class="row editable">
			<div class="gutter-grid repeatable">
				<div class="colspan12-6 as-grid with-gutter">
					<h4>Alex Wertheim</h4>
					<p>Alexander founded SPACiO Design Build and has been involved with real estate and condo owner relationships for the majority of his professional life. A General Contractor by trade, Alex started as Asset Manager for a major NY Real Estate Developer overseeing several apartment complexes in Connecticut and upon returning to South Florida started a Commercial and Residential General Contractor firm as a precursor to SPACiO Design Build. Alexander oversees Sales and Operations and plays a critical role in ensuring our product offerings exceed our customer’s expectations.</p>
				</div>
				<div class="colspan12-6 as-grid with-gutter">
					<h4>Brian Nisula</h4>
					<p>Brian brings extensive career experience in construction and operations as an engineer, licensed Florida contractor, and developer to SPACiO Design Build. Throughout his career, Brian has overseen high-end home building and remodeling, as well as commercial real estate development.  Within SPACiO Design Build, Brian’s primary focus is the continued development and refinement of proprietary software and workflow processes that ensure the on-time and on-budget completion of projects and overall customer satisfaction.</p>
				</div>
			</div>
			<div class="gutter-grid repeatable">
				<div class="colspan12-6 as-grid with-gutter">
					<h4>Francesco Lignarolo</h4>
					<p>A Certified General Contractor, Francesco has constructed over 1,000,000 SF of space including residential, mixed use, office, and retail in South America and South Florida.  His 20 plus years of experience in construction and project management with Owners, architects, engineers, and building officials delivers our clients the highest level of technical expertise that large projects demand.  Francesco’s knowledge, organizational, analytical, and problem solving skills make him an invaluable asset to the SPACiO team.</p>
				</div>
				<div class="colspan12-6 as-grid with-gutter">
					<h4>Ken Nisula</h4>
					<p>Ken’s 15-year Project Management career experience in construction operations and procedures allows him to proficiently implement highly complex initiatives.  He works directly with Owners, government agencies, general contractors, and consultants to provide a finished product that exceeds client expectations. His expertise ranges from base building oversight to tenant build-outs to high-end residential development.  This in-depth experience allows him to support clients with issues such as coordination of project plans, permit acquisition, coordination of major utilities, and monitoring compliance of contract terms.</p>
				</div>
			</div>	
		</div>
	</div>
	...
	<div class="remodal typeset editable" id="services-modal" data-remodal-id="services">
		...
		<p>When a high-end, time-sensitive commercial construction project arises, SPACIO is always top of mind with clients. And the reasons why are simple –we’re intensely proactive, and our distinctive marriage of design/build talents sets us apart from any competitor. We’re about giving clients a team that delivers on their promise, every step of the way.</p>
		<ul>
			<li>Flooring</li>
			<li>Paint/trim</li>
			<li>Countertops</li>
