...
<nav class="banner banner--clone">
	<div class="row">
		...
		<ul>
			<li><a class="comm-link" href="#top">Commercial</a></li>
		...
		<div id="showHere" class="row">
			<h1 class="hero-headline editable" id="the-hero-headline">EXPERTISE,<br />FROM EVERY ANGLE.</h1>
		</div>
	</div>
	...
	<section class="row" id="about-us">
		...
		<div class="colspan12-5 as-grid with-gutter">
			...
			<div class="tiles">
				...
				<div class="tile tile-5"><img class="tile-ani2" src="_/img/logos_4.png" alt=""></div>
				<div class="tile tile-7"><img class="tile-ani1" src="_/img/logos_5.png" alt=""></div>
			</div>
		</div>
	</section>
		...
		<div id="our-work" class="colspan12-12 portfolio-window">
			...
			<div id='portfolio' class='swipe' data-velocity="-0.2">
				<ul id="portfolio-pictures" class='swipe-wrap editable-gallery' data-links="false">
					<li><img src="media/photos/portfolio/comm/comm1.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/comm/comm2.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/comm/comm3.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/comm/comm4.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/comm/comm5.jpg" alt=""></li>
...
<section class="row typset">
	...
	<div class="colspan12-6 colspan6-3 as-grid review" id="review1">
		<blockquote class="editable">
			<p class="quote">For our daunting 224 room and corridor renovation project here at Marriott South Beach, we knew efficiency was critical, and adhering to budget was a mandate. Under severely tight time restrictions, SPACiO not only rose to the challenge, they surpassed every expectation. They complete this immense task ahead of schedule and under budget – and their quality of work was indeed superior.</p>
			<p class="source"><b>Diego Ardid</b> <br>Vice President, Key International, Komar Investments, Inc., Eden Roc LLP</p>
		</blockquote>
	</div>
	<div class="colspan12-6 colspan6-3 as-grid with-gutter review" id="review2">
		<blockquote class="editable">
			<p class="quote">The SPACiO team delivered as advertised – their adept handing of all pre-construction needs was impressive. They professionally coordinated the array of entities involved in this major project in a manner that impacted the hotel operations as minimally as possible. This invaluable service, along with their stellar work, simply reinforced the reputation they’ve built in this industry.</p>
			<p class="source"><b>GM</b> <br>Marriott South Beach</p>
		</blockquote>
	</div>
</section>
</div>
...
<!-- //////   BEGIN MODALS    ////// -->
	...
	<div class="remodal typeset editable" id="services-modal" data-remodal-id="services">
		<h1>SERVICES</h1>
		<p>When a high-end, time-sensitive commercial construction project arises, SPACiO is always top of mind with clients. This is because we proficiently analyze project parameters during project development, delivering efficiencies that enhance speed and reduce cost.</p>
		<ul>
	...
	<div class="remodal typeset editable" id="project1-modal" data-remodal-id="details1">
		<h1>SOUTH BEACH MARRIOTT</h1>
		<p>SPACiO is lending its design build expertise to the various entities that reside in the South Beach Marriott. Our work will span elevating the environments of its restaurants - including American Poolside Bar & Bistro, a gourmet Mexican Restaurant, and a Japanese Restaurant - renovating the spa and gym, as well as adding a new pool facility.</p>
	</div>

	<div class="remodal typeset editable" id="project2-modal" data-remodal-id="details2">
		<h1>EDEN ROC HOTEL</h1>
		<p>The Eden Roc Hotel is aligned with the renowned Nobu brand, and this client has tapped SPACiO carry the immense responsibility of this high-profile project. They are relying on our unique marriage of efficiency, responsiveness, and quality as we play a lead role in building the Nobu restaurant and 200 Nobu rooms, as well as in renovating the lobby and poolside bar & bistro.</p>
	</div>
