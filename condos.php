...
<nav class="banner banner--clone">
		...
		<div id="our-work" class="colspan12-12 portfolio-window">
			...
			<div id='portfolio' class='swipe' data-velocity="-0.2">
				<ul id="portfolio-pictures" class='swipe-wrap editable-gallery' data-links="false">
					<li><img src="media/photos/portfolio/condo/condo1.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo2.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo3.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo4.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo5.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo6.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo7.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo8.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo9.jpg" alt=""></li>
					<li><img src="media/photos/portfolio/condo/condo10.jpg" alt=""></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="project colspan12-8 colspan6-4 as-grid">
			...
			<div id='current1' class='swipe'>
				<ul id="slider-pictures1" class='swipe-wrap editable-gallery' data-links="false">
					<li><img src="media/photos/projects/condo/1/hyde1.jpg" alt=""></li>
					<li><img src="media/photos/projects/condo/1/hyde3.jpg" alt=""></li>
				</ul>
			</div>
		</div>
		<div class="colspan12-4 colspan6-2 as-grid with-gutter" id="description-1">
			<div id="descript1" class="editable">
				<h5>Hyde Beach Resort & Residences</h5>
			<div class="next-prev">
				<button class="prev" onclick='current1.prev()'>«</button> 
				<button class="next" onclick='current1.next()'>»</button>
			</div>
				<p>SPACiO is proud to bring our talents and experience to the illustrious Hyde Beach Resort & Residences. This condominium complex maintains 41 floors that encompass 407 premier luxury units overlooking the Atlantic Ocean.</p>
			</div>
		...
		<div class="project colspan12-8 colspan6-4 as-grid">
			...
			<div id='current2' class='swipe'>
				<ul id="slider-pictures2" class='swipe-wrap editable-gallery' data-links="false">
					<li><img src="media/photos/projects/condo/2/brickell1.jpg" alt=""></li>
					<li><img src="media/photos/projects/condo/2/brickell9.jpg" alt=""></li>			
				</ul>
			</div>
		</div>
		<div class="colspan12-4 colspan6-2 as-grid with-gutter" id="description-2">
			<div id="descript2" class="editable">
				<h5>Brickell Heights</h5>
			<div class="next-prev">
				<button class="prev" onclick='current2.prev()'>«</button> 
				<button class="next" onclick='current2.next()'>»</button>
			</div>
				<p>The new Brickell Heights condominium community resides in the heart of the prestigious Brickell area. The initial two-tower project consists of 690 residential units on 49 floors..</p>
			</div>
	...
	<div class="remodal typeset editable" id="project1-modal" data-remodal-id="details1">
		<h1>HYDE BEACH RESORT & RESIDENCES</h1>
		<p>SPACiO is proud to bring our talents and experience to the illustrious Hyde Beach Resort & Residences. This condominium complex maintains 41 floors that encompass 407 premier luxury units overlooking the Atlantic Ocean. Not only will owners enjoy stunning views of the water outside, they’ll appreciate the distinction that SPACiO can help create inside. We adeptly carry through the design theme of the building – organic materials, natural wood and stone – to create a truly comforting atmosphere.</p>
		</div>

		<div class="remodal typeset editable" id="project2-modal" data-remodal-id="details2">
			<h1>BRICKELL HEIGHTS</h1>
			<p>The new Brickell Heights condominium community resides in the heart of the prestigious Brickell area. The initial two-tower project consists of 690 residential units on 49 floors. In what will fast become an iconic structure, SPACiO will enable Brickell Heights owners to enjoy a living space that not only reflects the unique architecture of the building, but also speaks to their individual creative styles.</p>
				</div>
